...
# -*- coding: utf-8 -*-
"""
File:       tfio4v2_get_channel.py
Project:    Domoticz-Home-Automation-Workbook
Purpose:    Get for the bricklet channels 0-3 the values 1 (high) or 0 (low).
...
"CHANNELS":json array - Channels 0 to 3 with value, ie. [{"channel":0},{"channel":1}]}'
"channel":integer - Channel number 0-3 (mandatory)
Example:
Get channel 0 = '{"UID":"G4d","CHANNELS":[{"channel":0}]}'
Result
