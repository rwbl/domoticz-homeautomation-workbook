...
local DOMOTICZURL = 'http://rpi-ip-address:8080'
-- The request url uses from=1 minutes ago to to=now - Note: spaces to be replaced by plus signs in the url
local REQUESTURL = 'http://vz-ip-address/middleware.php/data/5b8ea2a0-b342-11e8-bec6-15c040e6d041.json?from=1+minutes+ago&to=now'
